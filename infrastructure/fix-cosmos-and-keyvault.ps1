# Fix failed Cosmos DB and create Key Vault
...
Write-Host "Fixing PolicyWonk Infrastructure" -ForegroundColor Cyan
Write-Host "============================================================================`n" -ForegroundColor Cyan
...
Write-Host "`n[Step 2/5] Creating Cosmos DB account..." -ForegroundColor Yellow
az cosmosdb create `
    --name $CosmosName `
    --resource-group $ResourceGroupName `
...
Write-Host "  2. Test the full AI processing at:" -ForegroundColor White
